...
export type NightPlansResponseRt = NewNightPlans | NewPlansRt | NightPlansError;

export type Query = {
  __typename?: 'Query';
  schedule: Scalars['String'];
  scheduleRt: Scalars['String'];
  version: Version;
...
export type QueryScheduleRtArgs = {
...
export type ScheduleRtQueryVariables = Exact<{
  scheduleId: Scalars['String'];
  startTime: Scalars['String'];
  endTime: Scalars['String'];
  nightStartTime: Scalars['String'];
...
export type ScheduleRtQuery = { __typename?: 'Query', scheduleRt: string };
...
export type UpdateWeatherMutation = { __typename?: 'Mutation', updateWeather?: { __typename?: 'Weather', imageQuality?: number | null, cloudCover?: number | null, windDirection?: number | null, windSpeed?: number | null } | null };
...
export type WeatherUpdatesSubscription = { __typename?: 'Subscription', weatherUpdates?: { __typename?: 'Weather', imageQuality?: number | null, cloudCover?: number | null, windDirection?: number | null, windSpeed?: number | null } | null };
...
export const WeatherUpdatesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"weatherUpdates"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"site"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"weatherUpdates"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"site"},"value":{"kind":"Variable","name":{"kind":"Name","value":"site"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"imageQuality"}},{"kind":"Field","name":{"kind":"Name","value":"cloudCover"}},{"kind":"Field","name":{"kind":"Name","value":"windDirection"}},{"kind":"Field","name":{"kind":"Name","value":"windSpeed"}}]}}]}}]} as unknown as DocumentNode<WeatherUpdatesSubscription, WeatherUpdatesSubscriptionVariables>;