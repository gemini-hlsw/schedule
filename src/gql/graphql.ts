...
export type GetNightPlansQuery = { __typename?: 'Query', schedule: { __typename?: 'NewNightPlans', plansSummary: any, nightPlans: Array<{ __typename?: 'SPlans', nightIdx: number, plansPerSite: Array<{ __typename?: 'SPlan', endTime: any, site: Site, startTime: any, visits: Array<{ __typename?: 'SVisit', atomEndIdx: number, atomStartIdx: number, obsId: any, startTime: any, endTime: any, altitude: Array<number>, instrument: string }>, nightStats: { __typename?: 'SNightStats', completionFraction: any, nToos: number, planConditions: any, planScore: number, timeloss: string } }> }> } };
