...
export type Query = {
  __typename?: 'Query';
  availablePrograms: Array<Scalars['String']>;
...
export type AvailableProgramsQuery = { __typename?: 'Query', availablePrograms: Array<string> };
